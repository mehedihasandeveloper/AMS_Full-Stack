...
export class CashAccountComponent implements OnInit {
  ...
  onSearch() {
    ...
    this.http.searchCash(this.textInputValue, this.startDate, this.endDate).subscribe((r: any) => {
...
// getAll() {
//   this.http.getAllCash().subscribe((result: any)=>{
//     this.cashAccountDetails = result;
//   })
// }
