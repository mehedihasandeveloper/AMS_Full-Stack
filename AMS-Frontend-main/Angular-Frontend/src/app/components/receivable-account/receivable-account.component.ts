...
@Component({
  selector: 'app-receivable-account',
  templateUrl: './receivable-account.component.html',
  styleUrls: ['./receivable-account.component.scss']
})
export class ReceivableAccountComponent implements OnInit{
  ...
  onSearch() {
    ...
    this.http.searchReceivable(this.textInputValue, this.startDate, this.endDate).subscribe((r: any) => {
