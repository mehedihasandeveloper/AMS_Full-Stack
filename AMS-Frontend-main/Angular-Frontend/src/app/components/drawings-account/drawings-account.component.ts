...
@Component({
  selector: 'app-drawings-account',
  templateUrl: './drawings-account.component.html',
  styleUrls: ['./drawings-account.component.scss']
})
export class DrawingsAccountComponent implements OnInit{
  ...
  onSearch() {
    ...
    this.http.searchDrawings(this.textInputValue, this.startDate, this.endDate).subscribe((r: any) => {
