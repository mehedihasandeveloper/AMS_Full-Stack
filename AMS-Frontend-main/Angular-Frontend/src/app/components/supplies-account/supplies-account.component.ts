...
@Component({
  selector: 'app-supplies-account',
  templateUrl: './supplies-account.component.html',
  styleUrls: ['./supplies-account.component.scss']
})
export class SuppliesAccountComponent implements OnInit{
  ...
  onSearch() {
    ...
    this.http.searchSupplies(this.textInputValue, this.startDate, this.endDate).subscribe((r: any) => {
